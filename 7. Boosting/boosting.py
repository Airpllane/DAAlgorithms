...
with open('../3. Bayes/metrics_3.json', 'r') as fp:
    metrics_3 = json.load(fp)

with open('../4. Dectree/metrics_4.json', 'r') as fp:
    metrics_4 = json.load(fp)

with open('../5. Bagging/metrics_5.json', 'r') as fp:
    metrics_5 = json.load(fp)
    
with open('../6. RandForest/metrics_6.json', 'r') as fp:
    metrics_6 = json.load(fp)
...
ax[0, 0].plot(est_nums[:len(metrics_5['TrainAccuracy'])], metrics_5['TrainAccuracy'][:min(len(est_nums), len(metrics_5['TrainAccuracy']))])
ax[0, 0].plot(est_nums[:len(metrics_5['TestAccuracy'])], metrics_5['TestAccuracy'][:min(len(est_nums), len(metrics_5['TestAccuracy']))])
ax[0, 0].plot(est_nums[:len(metrics_6['TrainAccuracy'])], metrics_6['TrainAccuracy'][:min(len(est_nums), len(metrics_6['TrainAccuracy']))])
ax[0, 0].plot(est_nums[:len(metrics_6['TestAccuracy'])], metrics_6['TestAccuracy'][:min(len(est_nums), len(metrics_6['TestAccuracy']))])
ax[0, 0].legend(['Train set', 'Test set', 'Bayes train set', 'Bayes test set', 'DecTree train set', 'DecTree test set', 'Bagging train set', 'Bagging test set', 'RandForest train set', 'RandForest test set'])
...
ax[0, 1].plot(est_nums[:len(metrics_5['TrainPrecision'])], metrics_5['TrainPrecision'][:min(len(est_nums), len(metrics_5['TrainPrecision']))])
ax[0, 1].plot(est_nums[:len(metrics_5['TestPrecision'])], metrics_5['TestPrecision'][:min(len(est_nums), len(metrics_5['TestPrecision']))])
ax[0, 1].plot(est_nums[:len(metrics_6['TrainPrecision'])], metrics_6['TrainPrecision'][:min(len(est_nums), len(metrics_6['TrainPrecision']))])
ax[0, 1].plot(est_nums[:len(metrics_6['TestPrecision'])], metrics_6['TestPrecision'][:min(len(est_nums), len(metrics_6['TestPrecision']))])
ax[0, 1].legend(['Train set', 'Test set', 'Bayes train set', 'Bayes test set', 'DecTree train set', 'DecTree test set', 'Bagging train set', 'Bagging test set', 'RandForest train set', 'RandForest test set'])
...
ax[1, 0].plot(est_nums[:len(metrics_5['TrainRecall'])], metrics_5['TrainRecall'][:min(len(est_nums), len(metrics_5['TrainRecall']))])
ax[1, 0].plot(est_nums[:len(metrics_5['TestRecall'])], metrics_5['TestRecall'][:min(len(est_nums), len(metrics_5['TestRecall']))])
ax[1, 0].plot(est_nums[:len(metrics_6['TrainRecall'])], metrics_6['TrainRecall'][:min(len(est_nums), len(metrics_6['TrainRecall']))])
ax[1, 0].plot(est_nums[:len(metrics_6['TestRecall'])], metrics_6['TestRecall'][:min(len(est_nums), len(metrics_6['TestRecall']))])
ax[1, 0].legend(['Train set', 'Test set', 'Bayes train set', 'Bayes test set', 'DecTree train set', 'DecTree test set', 'Bagging train set', 'Bagging test set', 'RandForest train set', 'RandForest test set'])
...
ax[1, 1].plot(est_nums[:len(metrics_5['TrainF1'])], metrics_5['TrainF1'][:min(len(est_nums), len(metrics_5['TrainF1']))])
ax[1, 1].plot(est_nums[:len(metrics_5['TestF1'])], metrics_5['TestF1'][:min(len(est_nums), len(metrics_5['TestF1']))])
ax[1, 1].plot(est_nums[:len(metrics_6['TrainF1'])], metrics_6['TrainF1'][:min(len(est_nums), len(metrics_6['TrainF1']))])
ax[1, 1].plot(est_nums[:len(metrics_6['TestF1'])], metrics_6['TestF1'][:min(len(est_nums), len(metrics_6['TestF1']))])
ax[1, 1].legend(['Train set', 'Test set', 'Bayes train set', 'Bayes test set', 'DecTree train set', 'DecTree test set', 'Bagging train set', 'Bagging test set', 'RandForest train set', 'RandForest test set'])
ax[1, 1].set_title('F1')
...
#%% Save metrics
'''
with open('metrics_7.json', 'w') as fp:
